  ...
  'inline-flex items-center justify-center rounded-full font-regular border-2 px-4 py-1 text-sm transition-colors',
  {
    variants: {
      color: {
        ...
        grayMid: ' border-[var(--gray-mid)] text-black font-light',
        main1Solid: 'bg-[var(--main-1)] text-white',
        main1Hover:
          'bg-[var(--main-1)] text-white hover:bg-transparent hover:text-[var(--main-1)] border-2 border-[var(--main-1)]',
        main3: 'bg-[var(--main-3)] text-white',
...
function Badge({ className, color, size, ...rest }: BadgeProps) {
