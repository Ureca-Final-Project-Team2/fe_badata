...
export const AuthOverlay = () => {
  ...
  const handleKakaoLogin = () => {
    ...
    const allowedPaths = ['/', '/mypage', '/trade', '/rental'];
    const safeRedirectPath = allowedPaths.includes(currentPath) ? currentPath : '/';
    localStorage.setItem('redirectTo', safeRedirectPath);
