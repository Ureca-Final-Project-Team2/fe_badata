...
// 게시물 목록 조회
export const getTradePosts = async (): Promise<PostItem[]> => {
  const content: { postsResponse: PostItem[] } = await axiosInstance.get(END_POINTS.TRADES.LIST);
