...
import { COIN_HISTORY_DEFAULT_SIZE } from '@/features/mypage/coin-history/lib/constants';
import {
  useUserCoinHistoryQuery,
  useUserCoinQuery,
} from '@/features/mypage/coin-history/model/queries';
import { CoinBalanceSection } from '@/features/mypage/coin-history/ui/CoinBalanceSection';
import { CoinHistoryList } from '@/features/mypage/coin-history/ui/CoinHistoryList';
...
export default function CoinHistoryPage() {
  ...
  const { data: historyData, isLoading: historyLoading } = useUserCoinHistoryQuery({
    size: COIN_HISTORY_DEFAULT_SIZE,
  });
