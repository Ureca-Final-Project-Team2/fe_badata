    ...
    <OnboardingBackground>
      <div className="flex flex-col">
        ...
        <div className="flex-1 flex flex-col items-center px-8 text-center">
          ...
          {/* 제목 */}
          <h1 className="text-2xl font-bold text-[var(--black)] mb-4 mt-8">
            데이터 남거나 부족할 땐, 바다타
          </h1>

          {/* 설명 */}
          <p className="text-lg text-[var(--gray-dark)] mb-12 leading-relaxed">
            남는 데이터는 바다타에서 판매하고
            <br />
          ...
          <div className="flex items-center space-x-4">
            <button
              onClick={onNext}
              className="px-8 py-3 bg-[var(--main-5)] text-white rounded-full font-medium hover:bg-[var(--main-4)] transition-colors"
            >
              다음
            </button>
          </div>
