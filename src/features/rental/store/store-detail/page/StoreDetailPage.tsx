...
import {
  ...
  STORE_DETAIL_TABS,
  type TabValue,
} from '@/features/rental/store/store-detail/lib/storeDetailConstants';
import { useStoreLikeHooks } from '@/features/rental/store/store-detail/model/useStoreLikeHooks';
import ContentSection from '@/features/rental/store/store-detail/ui/ContentSection';
import ImageSection from '@/features/rental/store/store-detail/ui/ImageSection';
import InfoSection from '@/features/rental/store/store-detail/ui/InfoSection';
import {
  StoreDetailError,
  StoreDetailLoading,
} from '@/features/rental/store/store-detail/ui/StoreDetailStates';
import { getUserLocation } from '@/features/rental/utils/locationUtils';
