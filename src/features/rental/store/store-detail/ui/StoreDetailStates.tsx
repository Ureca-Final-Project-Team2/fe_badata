  ...
  >
    <div className="flex items-center justify-center h-64">
      <div className="flex flex-col items-center gap-4 text-center">
        ...
        <div className="text-[var(--gray-dark)]">{STORE_DETAIL_MESSAGES.ERROR}</div>
        <button
          className="px-4 py-2 bg-[var(--main-5)] text-[var(--white)] rounded-lg text-sm font-medium hover:bg-[var(--main-4)] transition-colors"
