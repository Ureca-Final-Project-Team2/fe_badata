...
import { normalizeApiParams } from '@/features/rental/map/utils/paramNormalizer';

import type { StoreListParams, StoreListResponse } from '@/features/rental/map/lib/types';
