...
import { TradeGifticonEditForm } from '@/features/trade/register/gifticon/ui/GifticonEditForm';
...
export default function GifticonEditPage({ params }: GifticonEditPageProps) {
