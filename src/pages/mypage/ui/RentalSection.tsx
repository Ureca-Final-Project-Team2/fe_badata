...
export const RentalSection = () => (
  <>
    <h2 className="font-body-semibold">나의 공유기 대여</h2>
    <section className="bg-[var(--main-1)] rounded-xl p-4 shadow-sm">
      <ul className="space-y-5">
        ...
        <li>
          <Link href="/mypage/like-store" className="flex items-center gap-3 group transition">
            <Image
        ...
        <li>
          <Link href="/mypage/restock-alarm" className="flex items-center gap-3 group transition">
            <Image
