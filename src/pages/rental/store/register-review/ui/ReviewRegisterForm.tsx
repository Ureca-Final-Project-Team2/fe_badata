...
import { usePostReviewMutation } from '@/pages/rental/store/register-review/model/mutations';
import {
  useQuickReplies,
  useReservationDetails,
} from '@/pages/rental/store/register-review/model/queries';
import {
  initialState,
  reviewFormReducer,
} from '@/pages/rental/store/register-review/model/reviewFormReducer';
import CommentSection from '@/pages/rental/store/register-review/ui/CommentSection';
import ImageUploadSection from '@/pages/rental/store/register-review/ui/ImageUploadSection';
import QuickReplySection from '@/pages/rental/store/register-review/ui/QuickReplySection';
import RatingSection from '@/pages/rental/store/register-review/ui/RatingSection';
import ReservationDetailsSection from '@/pages/rental/store/register-review/ui/ReservationDetailsSection';
