      ...
      >
        ...
        >
          ...
          <div className="flex gap-2">
            <button
              type="button"
              className="flex-1 py-2.5 px-3 rounded-lg border border-[var(--gray)] text-[var(--gray-dark)] font-body-semibold"
              onClick={handleClose}
            ...
            <button
              type="button"
              className={`flex-1 py-2.5 px-3 rounded-lg font-body-semibold${
                isSubmitting
