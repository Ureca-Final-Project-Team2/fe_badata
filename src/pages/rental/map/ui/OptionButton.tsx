...
const OptionButtonComponent = ({
  ...
  <button
    ...
    className={`min-w-[80px] px-3 py-1 h-[34px] rounded-full flex items-center justify-center font-label-semibold border-none shadow-none transition-colors duration-150 focus:outline-none focus:ring-2 focus:ring-[var(--main-5)] ${
