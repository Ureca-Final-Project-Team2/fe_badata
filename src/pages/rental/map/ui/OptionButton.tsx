...
const OptionButtonComponent = ({
  ...
  <button
    ...
    className={`w-[85px] h-[34px] rounded-full flex items-center justify-center font-label-semibold border-none shadow-none transition-colors duration-150 focus:outline-none ${
