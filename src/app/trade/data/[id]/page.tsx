...
const TradeDetailPage = lazy(() => import('@/features/trade/data/detail/page/DataDetailPage'));
...
export default async function DataDetailPage(props: Props) {
  ...
  return (
    <Suspense fallback={<DataDetailContentLoadingFallback />}>
      <TradeDetailPage
        tradeId={id}
        post={post}
